...
const KEY = 'membership_graduates';
...
const Graduates: React.FC = () => {
  ...
  const openView = (it: any) => setView({ open:true, title:'Graduate Details', body: (
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="text-xl font-semibold text-gray-800">Graduates</div>
