...
const KEY = 'membership_probationals';
...
const Probationals: React.FC = () => {
  ...
  const openView = (it: any) => setView({ open:true, title:'Probational Details', body: (
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="text-xl font-semibold text-gray-800">Probationals</div>
